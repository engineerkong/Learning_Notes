...
- 4.38 hours to confidence 99.95%

## SaaS, PaaS, IaaS 

- SaaS: Microsoft Intune
- PaaS: Azure App Service, Azure Backup, Azure files and Azure SQL Database
- IaaS: Azure VM Service, Azure Storage accounts, legacy Database， Azure Virtual Network
...
- Azure Blob Storage: can be used for IoT Hub and store Archive items (blob level). Azure Blob Storage is designed for storing large amounts of unstructured data, such as video and audio files. (CDN)
...
- Azure Data Lake Analytics: supported for IoT Hub. Can use Power BI to analyze and visualize data. On-Demand
...
- Azure Virtual Network: Isolated. Seperate to Public Subnet, Private Subnet (No Ineternet)
...
2. A Site-to-Site VPN gateway connection is used to connect your on-premises network to an Azure virtual network over an IPsec/IKE (IKEv1 or IKEv2) VPN tunnel. Static routing.
...
- Load Balancer: OSI Level 4 Transport
- Application Gateway: OSI Level 7 HTTP
...
- Azure Resources Management (ARM): allow you to programmatically create Azure resource via JSON template. Automates the deployments on the AZ cloud.
- Management groups: containers
- Azure Advisor: does not provide recommendations on how to improve the security of an Azure AD environment. Can generate a list of VM's "NOT" protected by backup. Azure Advisor provides recommendations on high availability, security, performance and cost. Analysis of how well they are using their services compared to industry best practices
...
- Tags: Identify Azure resources that are associated with specific cost centers and metadata.
...
- Microsoft Entra is a suite of identity and access management products offered by Microsoft. It is designed to help organizations manage and secure access to their digital assets and resources across a variety of platforms and environments.
- Service Health: After an outage, Service Health provides official incident reports called root cause analysis (RCA), which you can share with stakeholders.
...
- Identity security layer - vaildate your identity
- AuthN & AuthZ - establish identity and level of access
- Single Signed On (SSO) - one time cerdical
- Azure Active Directory
- Multi-Factor Authentication
- Conditional access - allow or deny access based on identity signal

## Goverance Strategy (Adoption Framwork)

- Azure RBAC: security principal, role definition, scope
- Resource Locks
- Resource Tags
- Azure Policy
- Azure Bluepoints
...
- The Microsoft Privacy Statement - data
- The Trust Center - documentation standard and support
- Azure compliance documentation - documentation compliance
...
- Service Level Agreement (SLA) from Microsoft: uptime and connectivity
- The Online Services Terms (OST) is a legal agreement between Microsoft and the customer that details the obligations by both parties concerning the processing and security of customer data and personal data.
- When you spend all the credit included with your Azure free account, Azure resources that you deployed are removed from production, and your Azure virtual machines are stopped and deallocated.
- 12 months notification
- General Availiability (GA) is when a service is considered ready to be used publicly by everyone.
- Azure Cloud services: Foundational, Mainstream, Specialized
...
- Authentication 认证 Authorisation 授权
