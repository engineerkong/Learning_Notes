...
- Azure ExpressRoute operates at Layer 3, the Network Layer, of the OSI model.
...
- Azure Advisor can generate a list of VM's "NOT" protected by backup. Azure Advisor provides recommendations on high availability, security, performance and cost.
